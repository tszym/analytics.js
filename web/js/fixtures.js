  ...
  .dimension("[Time]", "Temps", "T desc", "Time")
    .hierarchy("T1", "Years-Semesters", "semesters desc")
      ...
      .level("Level1", "Semester")
        .member("2010-S1", "S1", "2010-S1 desc")
        .member("2010-S2", "S2", "2010-S2 desc")
        .member("2011-S1", "S1", "2011-S1 desc")
        .member("2011-S2", "S2", "2011-S2 desc")
        .member("2012-S1", "S1", "2012-S1 desc")
        .member("2012-S2", "S2", "2012-S2 desc")
        .member("2013-S1", "S1", "2013-S1 desc")
        .member("2013-S2", "S2", "2013-S2 desc")
        .member("2014-S1", "S1", "2014-S1 desc")
        .member("2014-S2", "S2", "2014-S2 desc")
